...
class TrainModel:
    ...
    def model(self, X_train, X_test, y_train, y_test):
        ...
        model = XGBClassifier(tree_method='gpu_hist', best_params=self.best_model_params, random_state=self.random_state)
    ...
    def train(self):
        try:
            ...
            preprocess = Preprocessing(df=raw_data, feature=self.feature, label=self.label, test_size=self.test_size,
